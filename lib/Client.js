...
log.child = function () { return log }
let responseHandlerFactory
...
function Client (config) {
  ...
  responseHandlerFactory = require('./response')(log)
 ...
 * @returns {Promise} Resolves to a array of results on success, rejects with
 * an `Error` on failure.
 */
